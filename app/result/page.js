...
export default function Result() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-top pt-12 pb-0 p-20">
            ...
            {/* LOADING */}
            {generateQR && 
                <div className='absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center flex-col z-50 bg-black bg-opacity-90' onClick={()=>{
                    setGenerateQR(null)
                }}>
            ...
            <div className='relative w-[60%] mt-0 mx-auto flex justify-center items-center pointer-events-none'>
                <Image src='/result-title.png' width={999} height={170} alt='Zirolu' className='w-full' priority />
            </div>
            {imageResultAI && 
            <div className='relative w-[65%] mt-4 mx-auto flex justify-center items-center  border-2 border-[#D8BA78] rounded-sm'>
