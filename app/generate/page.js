    ...
    const handleGender = (e) => {
        ...
        if(e.target.value == 'man'){
            if(stylePrompt == 'style1'){
                setPrompt("The man in the racing car wears a red racing suit with logos. His helmet has a dark visor to protect his eyes. He grips the steering wheel with gloved hands, ready for the race. Inside the car, he's focused and ready to push himself to win. The view is captured from the side of the driver's seat. illustration, digital painting, trending on artstation, concept art, sharp focus, illustration, high quality, highly detailed, high resolution, like painting, extremely detailed, hyper realistic, zoom out view");
            }else if(stylePrompt == 'style2'){
                setPrompt("An architect who is a man engrossed in drawing against the backdrop of Dubai's cityscape at night, illuminated by a myriad of city lights, creating a captivating scene of urban brilliance.");
            }else if(stylePrompt == 'style3'){
                setPrompt("a man standing elegantly against the backdrop of a sprawling new york timesquare. He is dressed in a long sleeve formal attire, wearing a sleek evening gown or a sophisticated business suit, exuding confidence and grace. The man's attire complements the urban setting, with its tailored lines and refined details reflecting the modern and cosmopolitan vibe of the city. His posture is confident and composed as he gazes out at the city view, with tall skyscrapers rising in the background. The cityscape is alive with twinkling lights, bustling streets, and iconic landmarks, showcasing the dynamic energy and vibrancy of urban life. The man's expression is serene and contemplative, as if he is taking a moment to appreciate the beauty and excitement of the city around him. He may be holding a smartphone, adding a touch of sophistication to his ensemble. Overall, the illustration captures the timeless elegance and modern allure of a man in formal attire against the backdrop of a captivating city view.");
            }
        }else if(e.target.value == 'woman'){
            if(stylePrompt == 'style1'){
                setPrompt("The woman in the racing car wears a red racing suit with logos. Her helmet has a dark visor to protect her eyes. She grips the steering wheel with gloved hands, ready for the race. Inside the car, she's focused and ready to push herself to win. The view is captured from the side of the driver's seat. illustration, digital painting, trending on artstation, concept art, sharp focus, illustration, high quality, highly detailed, high resolution, like painting, extremely detailed, hyper realistic, zoom out view");
            }else if(stylePrompt == 'style2'){
                setPrompt("An architect who is a woman engrossed in drawing against the backdrop of Dubai's cityscape at night, illuminated by a myriad of city lights, creating a captivating scene of urban brilliance.");
            }else if(stylePrompt == 'style3'){
                setPrompt("a woman standing elegantly against the backdrop of a sprawling new york timesquare. She is dressed in a long sleeve formal attire, wearing a sleek evening gown or a sophisticated business suit, exuding confidence and grace. The woman's attire complements the urban setting, with its tailored lines and refined details reflecting the modern and cosmopolitan vibe of the city. She may be wearing heels that add to her stature, accentuating her poise and sophistication. Her posture is confident and composed as she gazes out at the city view, with tall skyscrapers rising in the background. The cityscape is alive with twinkling lights, bustling streets, and iconic landmarks, showcasing the dynamic energy and vibrancy of urban life. The woman's expression is serene and contemplative, as if she is taking a moment to appreciate the beauty and excitement of the city around her. She may be holding a clutch purse or a smartphone, adding a touch of sophistication to her ensemble. Overall, the illustration captures the timeless elegance and modern allure of a woman in formal attire against the backdrop of a captivating city view.");
            }
        }else if(e.target.value == 'woman-hijab'){
            if(stylePrompt == 'style1'){
                setPrompt("The hijabi woman in the racing car wears a red racing suit with logos. Her helmet has a dark visor to protect her eyes. She grips the steering wheel with gloved hands, ready for the race. Inside the car, she's focused and ready to push herself to win. The view is captured from the side of the driver's seat. illustration, digital painting, trending on artstation, concept art, sharp focus, illustration, high quality, highly detailed, high resolution, like painting, extremely detailed, hyper realistic, zoom out view");
            }else if(stylePrompt == 'style2'){
                setPrompt("A hijabi woman architect engrossed in drawing against the backdrop of Dubai's cityscape at night, illuminated by a myriad of city lights, creating a captivating scene of urban brilliance.");
            }else if(stylePrompt == 'style3'){
                setPrompt("a hijabi woman standing elegantly against the backdrop of a sprawling new york timesquare. She is dressed in a long sleeve formal attire, wearing a sleek evening gown or a sophisticated business suit, exuding confidence and grace. The woman's attire complements the urban setting, with its tailored lines and refined details reflecting the modern and cosmopolitan vibe of the city. She may be wearing heels that add to her stature, accentuating her poise and sophistication. Her posture is confident and composed as she gazes out at the city view, with tall skyscrapers rising in the background. The cityscape is alive with twinkling lights, bustling streets, and iconic landmarks, showcasing the dynamic energy and vibrancy of urban life. The woman's expression is serene and contemplative, as if she is taking a moment to appreciate the beauty and excitement of the city around her. She may be holding a clutch purse or a smartphone, adding a touch of sophistication to her ensemble. Overall, the illustration captures the timeless elegance and modern allure of a woman in formal attire against the backdrop of a captivating city view.");
            }
        }
        // console.log(prompt)
